...
HD_PWD='D:/Xilinx/Project/lab12/FPGALab-RISC-V-CPU-design/lab12.runs/text_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log text_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source text_mem.tcl
